...
<body>
  <nav id="nav-lg" class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
    <div class="container-fluid d-flex bd-highlight">
      <a class="navbar-brand mr-auto bd-highlight" href=<?php echo site_url() ?>>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link ml-3" href="<?php echo site_url() ?>">Kembali  <span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
